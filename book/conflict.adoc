...
Characters with zero total energy cannot participate in a conflict, but will suffer any consequences.
...
Use tokens of 3 different colors, sizes, and/or shapes to track your energy, e.g. light for Defend, dark for Attack, and contrasting for Grapple.
...
* Take a breather to regain 1 point of energy in the type of your choice. You cannot take another breather until after a full rest.
* Take a short rest to regain up to your maximum for the type of energy with the *lowest* maximum (your choice if there's a tie). You cannot take another short rest until after a full rest.
