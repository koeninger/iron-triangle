...
You start at level one. As you <<levelup.adoc#levelup>> you can learn specials and combos, but you do not start with any at level one.
...
[NOTE]
====
Don't worry about optimizing, just go with what fits your concept of your character's fighting style.
