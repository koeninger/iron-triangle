...
If you play a move that combos and win, your opponent will lose additional energy.
...
If you reach zero energy for one action type, mark it for purposes of <<levelup.adoc#levelup>>. This does not restrict your ability to play moves of that type, only your ability to choose a stance of that type.
